...
<div class="container marketing" id="marketing">
	...
	<div class="col-xs-8 col-md-8">
		...
		<p class="text-right">
		<input type="button" value="글쓰기"  onclick="location.href='DanCarMain.jsp?center=BoardWrite.jsp'"  class="btn btn-warning">
		</p>
...
<%-- 			<%
			...
			<td><a href="DanCarMain.jsp?center=BoardInfo.jsp?num=<%= bean.getNum() %>" >
			<%
...
%>
 <li><a href="DanCarMain.jsp?center=BoardList.jsp&pageNum=<%=paging.getPrev() %>" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>
 <%	
		}
 	 //페이징 처리
...
%>
	<li <% if(i==Integer.parseInt(pageNum))
		...
		%>><a href="DanCarMain.jsp?center=BoardList.jsp&pageNum=<%=i %>"><%=i %><span class="sr-only">(current)</span></a></li>
...
<li><a href="DanCarMain.jsp?center=BoardList.jsp&pageNum=<%=paging.getNext() %>" aria-label="next"><span aria-hidden="true">&raquo;</span></a></li>
<%		
